...
public class MainController extends HttpServlet {
    ...
    public String search(HttpServletRequest request, HttpServletResponse response)
        ...
        if (AuthUtils.isLoggedIn(session)) {
            ...
            List<ProjectDTO> projects = projectDAO.searchByTitle(searchTerm);
    ...
    public String update(HttpServletRequest request, HttpServletResponse response)
        ...
        if (AuthUtils.isAdmin(session)) {
            try {
                ...
                if (action != null && action.equals("getDetails")) {
                    // Fetch project details
                    int projectId = Integer.parseInt(request.getParameter("projectId"));
                    ProjectDTO project = projectDAO.readById(String.valueOf(projectId));
                    
                    if (project != null) {
                        request.setAttribute("projectDetails", project);
                    } else {
                        request.setAttribute("ERROR_UPDATE", "Project not found.");
                    }
                ...
                request.setAttribute("ERROR_UPDATE", "An error occurred while processing your request.");
                url = "updateStatus.jsp";
            }
        } else {
            url = "login.jsp";
