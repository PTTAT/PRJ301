                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <% 
                            if (AuthUtils.isUser(session)) {
                        %>
                        <td><a href="ansQuestion.jsp?exam_id=<%=b.getCategory_id()%>" class="action-link">
                                <img src="assets/images/Custom-Icon-Design-Flatastic-6-Add-anchor-point-tool.512.png" alt="Ans Question" class="action-icon" title="Ans Question"  style="height: 25px"/>
                            </a></td>
