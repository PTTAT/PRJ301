...
public class EmailUtils {
    ...
    private static final String EMAIL_USERNAME = "trananhtu17112004@gmail.com";
    private static final String EMAIL_PASSWORD = "mzngvnjmfhyxkojp";
     ...
     */
    public static boolean sendRegistrationEmail(String email, String name, String username) {
        try {
            ...
            String htmlContent = createRegistrationEmailContent(name, username);
     ...
     */
    private static String createRegistrationEmailContent(String name, String username) {
        return "<!DOCTYPE html>\n"
                + "<html>\n"
                + "<head>\n"
                + "    <meta charset=\"UTF-8\">\n"
     ...
     * @return true nếu gửi email thành công, false nếu có lỗi
     */
    public static boolean sendVerificationEmail(String email, String name, String token) {
        try {
            // Thiết lập các thuộc tính
            Properties props = new Properties();
            props.put("mail.smtp.auth", "true");
            ...
            String htmlContent = createVerificationEmailContent(name, verificationLink);
            message.setContent(htmlContent, "text/html; charset=utf-8");
    ...
    public static void main(String[] args) {
        sendRegistrationEmail("trananhtu17112004@gmail.com", "LNT", "LNT");
    }
}